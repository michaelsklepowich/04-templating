...
Article.prototype.toHtml = function() {
  ...
  // TODO: DONE Use the method that Handlebars gave you to return your filled-in html template for THIS article.
  return templateToRender(this);
};

// COMMENT: Why are there parentheses around "(a,b)" in the .sort() method, but not around the "articleObject" or "article" arguments in the .forEach() methods?
// There are parentheses around the (a,b) in the .sort() method because the .sort() method requires two elements to compare, whereas the .forEach method is just iterating through an array
rawData.sort((a,b) => {
